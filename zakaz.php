...
echo('<img width="1" src="http://tovarka.top/api/public_order?' . $get .'">');
...
if ($verify == 'true'){
   echo("<script type=\"text/javascript\">setTimeout('location.replace(\"{$success_url}\")',700);</script> ");
